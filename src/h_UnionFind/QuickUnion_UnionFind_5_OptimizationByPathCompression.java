...
public class QuickUnion_UnionFind_5_OptimizationByPathCompression implements UnionFind {
    private int[] parent;
    private int[] rank; //rank[i]表示以i为根的集合所表述树的深度的相对排名

    public QuickUnion_UnionFind_5_OptimizationByPathCompression(int size) {
